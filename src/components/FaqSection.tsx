        ...
        <div className="space-y-20">
          {faqGroups.map((group, groupIdx) => (
            ...
            >
              ...
              <div className="w-full md:w-2/3 divide-y divide-slate-100 border-t border-b border-slate-100">
                {group.questions.map((item) => {
                  ...
                  return (
                    <div key={item.id} className="py-2">
                      ...
                      >
                        <span className="text-base sm:text-lg font-normal text-slate-900 group-hover:text-slate-500 transition-colors leading-snug font-sans">
                          {item.question}
                        </span>
                      ...
                      <AnimatePresence initial={false}>
                        {isOpen && (
                          ...
                          >
                            <p className="text-slate-600 text-sm sm:text-base leading-[1.85] pb-5 pt-1 font-normal max-w-2xl">
                              {item.answer}
                            </p>
                          </motion.div>
                        )}
