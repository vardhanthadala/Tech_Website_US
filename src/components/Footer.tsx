      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-20 pb-16 border-b border-slate-100 text-sm font-normal">
          ...
          <div className="max-w-sm flex flex-col justify-between space-y-6">
            <div>
              <Link href="/" suppressHydrationWarning className="inline-block mb-4 group">
                <Image
                  src="/logo.png"
                  alt="Dexze Logo"
                  width={110}
                  height={32}
                  className="h-7 w-auto object-contain transition-transform group-hover:scale-105 opacity-90 hover:opacity-100"
                />
              </Link>
            ...
            <div className="flex items-center gap-4 text-slate-600 pt-1">
              <a href="https://x.com" target="_blank" rel="noreferrer" className="hover:text-slate-950 transition-colors p-1.5 rounded-lg hover:bg-slate-50" aria-label="X / Twitter">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-slate-950 transition-colors p-1.5 rounded-lg hover:bg-slate-50" aria-label="Instagram">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-slate-950 transition-colors p-1.5 rounded-lg hover:bg-slate-50" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
                  <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" />
                </svg>
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="hover:text-slate-950 transition-colors p-1.5 rounded-lg hover:bg-slate-50" aria-label="YouTube">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 sm:gap-14 lg:gap-20">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-slate-500 text-sm">
                ...
                <li><Link href="/projects/aura-health" className="hover:text-slate-900 transition-colors">Healthcare Apps</Link></li>
                <li><Link href="/projects/pluto" className="hover:text-slate-900 transition-colors">FinTech Platforms</Link></li>
                <li><Link href="/projects/lumina-luxury" className="hover:text-slate-900 transition-colors">E-Commerce</Link></li>
                <li><Link href="/projects/vixiv" className="hover:text-slate-900 transition-colors">AI & Robotics</Link></li>
              </ul>
            </div>
